...
- **360° panoramalar:** seçilen noktalardan tam çevre görünümü.
- **Gezilebilir sanal tur:** panoramaların birbirine bağlandığı, plan üzerinden gezinilen turlar.
- **Bilgi noktaları:** malzeme, ölçü ve açıklama etiketleri.
- **Paylaşım:** tarayıcıda açılan bağlantı; istenirse web sitenize gömülür ya da VR gözlükte kullanılır.
