...
related_tur: "konut"
faq:
  - q: "Kentsel dönüşüm projesi hangi aşamalardan oluşur?"
    a: "Mevcut yapının ve parselin analizi, imar durumunun okunması, yerleşim ve emsal etütleri, kütle alternatifleri, avan proje, ardından ruhsata esas mimari uygulama projesi ve diğer disiplinlerle koordinasyon. Her aşamanın sonunda hak sahipleriyle paylaşılabilir bir sunum hazırlanır."
  - q: "Tek parsel mi, ada bazlı dönüşüm mü çalışıyorsunuz?"
    a: "Her ikisi. Tek parsel dönüşümünde mevcut hakların korunması ve planın verimli kullanımı öne çıkar; ada bazlı çalışmalarda ortak alanlar, otopark çözümü ve kademeli uygulama planlanır."
...
1. İlk görüşme ve parsel bilgilerinin toplanması.
2. Analiz ve alternatifler: iki ya da üç kütle seçeneği, karşılaştırmalı tablo.
3. Avan proje ve hak sahipleri sunumu.
4. Uygulama projesi ve disiplin koordinasyonu.
5. Ruhsat sürecinde teknik destek.

Üsküdar başta olmak üzere İstanbul'un tamamında çalışıyoruz; projeyi Revit üzerinde tek bilgi modelinde yürüttüğümüz için metrajlar ve revizyonlar süreç boyunca tutarlı kalır.
