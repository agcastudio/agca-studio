...
faq:
  - q: "BIM ile klasik çizim arasındaki fark nedir?"
    a: "Klasik çizimde her plan, kesit ve görünüş ayrı bir dosyadır ve bir değişiklik hepsine elle işlenir. BIM modelinde yapı bir kez, üç boyutlu ve bilgi taşıyan öğelerle kurulur; çizimler bu modelden türetilir, bir değişiklik tüm sete aynı anda yansır ve metrajlar modelden okunur."
  - q: "Hangi proje aşamalarını hazırlıyorsunuz?"
    a: "Konsept ve avan proje, ruhsata esas mimari uygulama projesi, detay paftaları ve metraj listeleri. Statik, mekanik ve elektrik projeleriyle model üzerinden koordinasyon yapılır."
...
- **Konsept ve avan proje:** yerleşim, kütle, kat planları ve ilk görselleştirmeler.
- **Ruhsata esas uygulama projesi:** ilgili belediye ve yönetmelik gereklerine uygun mimari proje seti.
- **Detay paftaları:** cephe, merdiven, ıslak hacim ve doğrama detayları.
- **Metraj ve mahal listeleri:** modelden okunan, revizyonlarla güncellenen miktarlar.
- **Disiplin koordinasyonu:** statik, mekanik ve elektrik modelleriyle çakışma kontrolü.
