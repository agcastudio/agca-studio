...
faq:
  - q: "What is the difference between BIM and conventional drafting?"
    a: "In conventional drafting every plan, section and elevation is a separate file, and a change has to be carried into each by hand. In a BIM model the building is built once, in three dimensions, from elements that carry information; the drawings are derived from that model, a change appears in the whole set at once, and quantities are read from the model."
  - q: "Which stages do you prepare?"
    a: "Concept and schematic design, permit-ready architectural construction documents, detail sheets and quantity schedules. Coordination with structural, mechanical and electrical design takes place through the model."
  - q: "Do you share the model with the client?"
    a: "Yes. Alongside PDF and DWG output, the model can be delivered in Revit and IFC formats, and clients and contractors can also review the project through visualisations and virtual tours."
---
We design in Revit, within a single, consistent building information model (BIM). Plans, sections, elevations, details and quantities are produced from the same model; when a decision changes, the whole set of drawings updates at once. This prevents the most common problem on site: sheets that do not agree with each other.

## Scope

- **Concept and schematic design:** layout, massing, floor plans and first visualisations.
